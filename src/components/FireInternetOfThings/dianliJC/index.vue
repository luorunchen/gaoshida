...
export default {
  ...
  methods: {
    ...
    DeviceAlarm() {
      ...
      DeviceAlarm(this.utils.userName, "12", region).then((res) => {
...
#huozaibaojing {
  ...
  .leftWapper {
    ...
    width: 373px;
    .left_one {
      background-image: url("../../../assets/../assets/images/zhengchangbili.png");
      height: 450px;
    ...
    .left_two {
      background-image: url("../../../assets/../assets/images/juxing7.png");
      height: 300px;
  ...
  .rightWapper {
    ...
    width: 330px;
    .right_one {
      // background-image: ("../../../assets/../assets/images/zhengchangbili.png");
      height: 400px;
      background-size: 100% 100%;
      background-image: url("../../../assets/../assets/images/juxing5.png");
      .chaxun {
        padding-top: 20px;
        padding-left: 20px;
      }
